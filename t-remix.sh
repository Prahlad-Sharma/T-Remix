...
#  email: prahalad8426012@gmail.com  #
######################################
...
tput cup 6 30
echo -e "\x1b[42m PRAHLAD SHARMA'S HACKER PS channel \x1b[m"
tput cup 9 0
...
tput cup 20 0
figlet -f slant "PRAHLAD SHARMA'S HACKER PS" |lolcat
echo " "
echo " "
#done setting up
